...
type AppProps = {};
type AppState = { homeState: object; controlState: object; analysisState: object};
      ...
      <Router>
        ...
        <Switch>
            <Route exact path="/home"
                render={props =>
                    <HomePage
                        setState={(state, callback) => onPageUpdate('home', state, callback)}
            ...
            <Route exact path="/control"
                render={props =>
                    <ControlPage
                        setState={(state, callback) => onPageUpdate('control', state, callback)}
            ...
            <Route exact path="/analysis"
                render={props => 
                    <AnalysisPage
                        setState={(state, callback) => onPageUpdate('analysis', state, callback)}
